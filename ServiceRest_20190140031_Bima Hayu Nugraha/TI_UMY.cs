...
namespace ServiceRest_20190140031_Bima_Hayu_Nugraha
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source = LAPTOP-GVH5477F; Initial Catalog = \"TI UMY\"; Persist Security Info = True; User ID = sa; Password = bima071200");
